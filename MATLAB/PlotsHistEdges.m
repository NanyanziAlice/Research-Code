...
zGlass     = computeNumEdges('glass/obj18__','.png',90,4,3);       
zToy       = computeNumEdges('toys/obj48__','.png',55,4,4);        
zBowl      = computeNumEdges('bowls/obj25__','.png',150,5,4);
zCup       = computeNumEdges('cups/obj11__','.png',40, 8,7);
zBottle    = computeNumEdges('bottles/obj50__','.png',40,3,3);
zContainer = computeNumEdges('container/obj70__','.png',70, 3, 5);
zBirds     = computeNumEdges('birds/obj74__','.png',60, 4, 4);
zIcecream  = computeNumEdges('icecream/obj72__','.png',80, 4,3);
