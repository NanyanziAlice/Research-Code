...
figure(1)
h1 = histogram(zGlass,'FaceColor',[0.2 0.65 0.5]);
hold on 
h2 = histogram(zToy, 'FaceColor',[0 1 0], 'EdgeColor',[0,0,0]);
hold on
h3 = histogram(zBowl, 'FaceColor',[0 0 1]);
hold on
h4 = histogram(zCup,'FaceColor',[0 0.95 0.95]);
hold on
h5 = histogram(zBottle,'FaceColor',[0.75 0 0.75]);
hold on
h6 = histogram(zContainer,'FaceColor',[0.95 0.97 0.1]);
hold on
h7 = histogram(zBirds, 'FaceColor',[1 0 0]);
hold on
h8 = histogram(zIcecream,'FaceColor',[0 0 0]);   

ylabel('Frequency') % x-axis label
xlabel('Derivative of Zeta function value at Origin') % y-axis label
