...
lam = 7;                                                                %laplace exponent
egGlass     = computeFeatureVectorLaplace(s,lam,'glass/obj18__','.png',70,4,3)';%compute feature vector for each of the eight objects
egToy       = computeFeatureVectorLaplace(s,lam,'toys/obj48__','.png',70,4,4)'; 
egBowl      = computeFeatureVectorLaplace(s,lam,'bowls/obj25__','.png',30,5,4)';
egCup       = computeFeatureVectorLaplace(s,lam,'cups/obj11__','.png',30, 8,7)';
egBottle    = computeFeatureVectorLaplace(s,lam,'bottles/obj50__','.png',70,3,3)';
egContainer = computeFeatureVectorLaplace(s,lam,'container/obj70__','.png',70, 3, 5)';
egBird      = computeFeatureVectorLaplace(s,lam,'birds/obj74__','.png',30, 4, 4)';
egIcecream  = computeFeatureVectorLaplace(s,lam,'icecream/obj72__','.png',50, 4,3)';
