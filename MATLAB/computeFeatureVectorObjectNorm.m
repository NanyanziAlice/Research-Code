...
%%%%%%%%%function to compute feature vector of leading coefficient of heat content
            %%%%%%%%%polynomial (Normalised Laplacian)%%%%
...
function egMat = computeFeatureVectorObjectNorm(coeffList,direc,imagetype, thres, rup, rdown)
    ...
    for i = numview                                         % iterate over the different views of an object
        ...
        bk = createPolynomialFeatureVector(full(Ln), coeffList);
