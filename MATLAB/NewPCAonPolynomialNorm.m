...
%PCA analysis based on leading coefficients of Heat content %%%%%%


% arguments to the computeFeatureVecNorm() function %%%%%%%%
%first  : list of leading coefficients of Heat content
...
egGlass     = computeFeatureVectorObjectNorm(s,'glass/obj18__','.png',90,4,3);   %compute feature vector for each of the eight objects
egToy       = computeFeatureVectorObjectNorm(s,'toys/obj48__','.png',55,4,4); 
egBowl      = computeFeatureVectorObjectNorm(s,'bowls/obj25__','.png',150,5,4);
egCup       = computeFeatureVectorObjectNorm(s,'cups/obj11__','.png',40, 8,7);
egBottle    = computeFeatureVectorObjectNorm(s,'bottles/obj50__','.png',40,3,3);
egContainer = computeFeatureVectorObjectNorm(s,'container/obj70__','.png',70,3,5);
egBird      = computeFeatureVectorObjectNorm(s,'birds/obj74__','.png',60, 4, 4);
egIcecream  = computeFeatureVectorObjectNorm(s,'icecream/obj72__','.png',80, 4,3);
