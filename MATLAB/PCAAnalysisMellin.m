...
sm = 7;
egGlass     = computeFeatureVectorMellin(s,sm,'glass/obj18__','.png',70,4,3)';%compute feature vector for each of the eight objects
egToy       = computeFeatureVectorMellin(s,sm,'toys/obj48__','.png',70,4,4)'; 
egBowl      = computeFeatureVectorMellin(s,sm,'bowls/obj25__','.png',30,5,4)';
egCup       = computeFeatureVectorMellin(s,sm,'cups/obj11__','.png',30, 8,7)';
egBottle    = computeFeatureVectorMellin(s,sm,'bottles/obj50__','.png',70,3,3)';
egContainer = computeFeatureVectorMellin(s,sm,'container/obj70__','.png',70, 3, 5)';
egBird      = computeFeatureVectorMellin(s,sm,'birds/obj74__','.png',30, 4, 4)';
egIcecream  = computeFeatureVectorMellin(s,sm,'icecream/obj72__','.png',50, 4,3)';
