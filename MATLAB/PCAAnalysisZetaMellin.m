...
sm = 7;                                                                       %set s exponent of the Mellin
egGlass     = computeFeatureVectorZetaMellin(sm,s,'glass/obj18__','.png',70,4,3)';%compute feature vector for each of the eight objects
egToy       = computeFeatureVectorZetaMellin(sm,s,'toys/obj48__','.png',70,4,4)'; 
egBowl      = computeFeatureVectorZetaMellin(sm,s,'bowls/obj25__','.png',30,5,4)';
egCup       = computeFeatureVectorZetaMellin(sm,s,'cups/obj11__','.png',30, 8,7)';
egBottle    = computeFeatureVectorZetaMellin(sm,s,'bottles/obj50__','.png',70,3,3)';
egContainer = computeFeatureVectorZetaMellin(sm,s,'container/obj70__','.png',70, 3, 5)';
egBird      = computeFeatureVectorZetaMellin(sm,s,'birds/obj74__','.png',30, 4, 4)';
egIcecream  = computeFeatureVectorZetaMellin(sm,s,'icecream/obj72__','.png',50, 4,3)';
