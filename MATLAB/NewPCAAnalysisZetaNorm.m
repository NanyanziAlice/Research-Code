...
%PCA analysis based on feature vectors of the zeta function for different
%integer parameters %%%%
...
egCup       = computeFeatureVectorZetaNorm(s,'cups/obj11__','.png',40, 8,7);
egBottle    = computeFeatureVectorZetaNorm(s,'bottles/obj50__','.png',40,3,3);
egContainer = computeFeatureVectorZetaNorm(s,'container/obj70__','.png',70, 3, 5);
egBird      = computeFeatureVectorZetaNorm(s,'birds/obj74__','.png',60, 4, 4);
egIcecream  = computeFeatureVectorZetaNorm(s,'icecream/obj72__','.png',80, 4,3);
