...
img = imread(strcat('cups/obj11__',num2str(15),'.png'));  %read the image by specifying the name and view number
im=rgb2gray(img);                                        %change the read image to gray scale
[cim,r,c]= harris1(im,1,31,2);                           %Perform Harris corner detection with arguments
