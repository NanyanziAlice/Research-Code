...
%%%%%%%%%function to compute feature vector of leading eigenvalues of
            %%%%%%%%%(Mellin based Laplacian)%%%%
            
%%%% Arguments of the function %%%%%
%%% 1st: number of leading eigenvalues to consider 
%%% 2nd: exponent of Mellin, smellin
...
function egMat = computeFeatureVectorMellin(s,smellin,direc,imagetype, thres, rup, rdown)
    ...
    for i =numview
        ...
        %Compute Mellin based Laplacian matrix
        L = computeMellin(G,smellin);
