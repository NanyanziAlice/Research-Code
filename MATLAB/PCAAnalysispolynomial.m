%PCA analysis based on heat content cpefficients %%%%%

%compute feature vector of heat content cpefficients for the objects
m = [1,2,3,4];                                                                %list of k leading polynomials
egGlass     = computePolynomialFeatureVec(m,'glass/obj18__','.png',70,4,3)';%compute feature vector for each of the eight objects
egToy       = computePolynomialFeatureVec(m,'toys/obj48__','.png',70,4,4)'; 
egBowl      = computePolynomialFeatureVec(m,'bowls/obj25__','.png',30,5,4)';
egCup       = computePolynomialFeatureVec(m,'cups/obj11__','.png',30, 8,7)';
egBottle    = computePolynomialFeatureVec(m,'bottles/obj50__','.png',70,3,3)';
egContainer = computePolynomialFeatureVec(m,'container/obj70__','.png',70, 3, 5)';
egBird      = computePolynomialFeatureVec(m,'birds/obj74__','.png',30, 4, 4)';
egIcecream  = computePolynomialFeatureVec(m,'icecream/obj72__','.png',50, 4,3)';
