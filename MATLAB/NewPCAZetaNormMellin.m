...
s = 6;                     %set value of Mellin exponent s
p = [1,2,3,4];             %size of the leading eigenvalues

egGlass     = computeFeatureVectorZetaMellin(s,p,'glass/obj18__','.png',90,4,3); 
egToy       = computeFeatureVectorZetaMellin(s,p,'toys/obj48__','.png',55,4,4); 
egBowl      = computeFeatureVectorZetaMellin(s,p,'bowls/obj25__','.png',150,5,4);
egCup       = computeFeatureVectorZetaMellin(s,p,'cups/obj11__','.png',40, 8,7);
egBottle    = computeFeatureVectorZetaMellin(s,p,'bottles/obj50__','.png',40,3,3);
egContainer = computeFeatureVectorZetaMellin(s,p,'container/obj70__','.png',70, 3, 5);
egBird      = computeFeatureVectorZetaMellin(s,p,'birds/obj74__','.png',60, 4, 4);
egIcecream  = computeFeatureVectorZetaMellin(s,p,'icecream/obj72__','.png',80, 4,3);
