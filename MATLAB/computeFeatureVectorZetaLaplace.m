...
%%%%%%%%%function to compute feature vector of zeta function
            %%%%%%%%%(Laplacian based Normalised Laplacian)%%%%
            
%%%% Arguments of the function %%%%%
%%% 1st: Laplacian exponents, lambda
...
function egMat = computeFeatureVectorZetaLaplace(lam,s,direc,imagetype, thres, rup, rdown)
