...
lam = 7;                                                                       %set s exponent of the Mellin
egGlass     = computeFeatureVectorZetaLaplace(lam,s,'glass/obj18__','.png',70,4,3)';%compute feature vector for each of the eight objects
egToy       = computeFeatureVectorZetaLaplace(lam,s,'toys/obj48__','.png',70,4,4)'; 
egBowl      = computeFeatureVectorZetaLaplace(lam,s,'bowls/obj25__','.png',30,5,4)';
egCup       = computeFeatureVectorZetaLaplace(lam,s,'cups/obj11__','.png',30, 8,7)';
egBottle    = computeFeatureVectorZetaLaplace(lam,s,'bottles/obj50__','.png',70,3,3)';
egContainer = computeFeatureVectorZetaLaplace(lam,s,'container/obj70__','.png',70, 3, 5)';
egBird      = computeFeatureVectorZetaLaplace(lam,s,'birds/obj74__','.png',30, 4, 4)';
egIcecream  = computeFeatureVectorZetaLaplace(lam,s,'icecream/obj72__','.png',50, 4,3)';
